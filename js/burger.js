...
homeButton.addEventListener('click', () => {
  ...
  prov = 0;
  gsap.to(window, {duration: 2,delay:.5,scrollTo: ".section1",ease: CustomEase.create("custom", "M0,0 C.7,0 .3,1 1,1")});}
  else{
    gsap.to(window, {duration: 2,scrollTo: ".section1",ease: CustomEase.create("custom", "M0,0 C.7,0 .3,1 1,1")});
  }
});
...
contactButton.addEventListener('click', () => {
    if (!mediaQuery.matches){
        ...
        gsap.to(window, {duration: 2, scrollTo: "footer",ease: CustomEase.create("custom", "M0,0 C.7,0 .3,1 1,1")});
    }
});
