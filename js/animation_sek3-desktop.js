...
gsap.fromTo(blockComments.children[0], { top: "20vh" }, { top: "0vh", scrollTrigger: {trigger: ".section2",start: 510*vh,end: 570*vh}});
gsap.fromTo(blockComments.children[1], { top: "20vh" }, { top: "0vh", scrollTrigger: {trigger: ".section2",start: 535*vh,end: 570*vh}});
gsap.fromTo(blockComments.children[2], { top: "20vh" }, { top: "0vh", scrollTrigger: {trigger: ".section2",start: 540*vh,end: 570*vh}});
